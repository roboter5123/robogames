...
public class GameLoopTask extends BukkitRunnable {
	...
	public GameLoopTask(GameService gameService, PlayerService playerService, SchedulerService schedulerService, SpawnService spawnService, LanguageService languageService,
		Long tickInterval) {
	...
	private void endGameWithWinner() {
		...
		BukkitRunnable winnerBroadCastTask = new BroadCastIngameTask(this.playerService, message).run();
